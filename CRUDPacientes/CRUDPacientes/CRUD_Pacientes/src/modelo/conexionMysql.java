...
public class conexionMysql {
    ...
    public Connection conexion(){  //método público conexion
        ...
        try{ //captura los errores
            ...
            conectar=DriverManager.getConnection("jdbc:mysql://localhost/bdcrudpaciente?useSSL=false&serverTimezone=America/Bogota","root","123456"); //inicializamos nuestra variable conectar
